...
public class TC_38SearchLeadByClickingOnLastName  {
static {
    ...
    //	System.out.println(workbook.getSheet("Sheet1").getRow(1).getCell(3).getStringCellValue());
    	...
    	String dat = excel.getExcelData("Sheet1", 7, 1);
    	String dat1 = excel.getExcelData("Sheet1", 7, 2);
    	String dat2 = excel.getExcelData("Sheet1", 7, 3);
  ...
  /*  	driver.findElement(By.xpath("//input[@type='text' and @name='user_name']")).sendKeys(username);
	...
	/*	driver.findElement(By.xpath("//input[@accesskey='S']")).click();
		...
		Thread.sleep(5000);
		ld.verifyResult(driver);hm.logout(driver).click();
